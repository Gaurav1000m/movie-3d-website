...
function HeroWatchlistBtn({ movie }) {
  ...
  return (
    <button 
      ...
      className={`flex items-center justify-center gap-2 px-6 sm:px-8 py-3.5 border transition-all duration-300 rounded-md font-bold tracking-wide backdrop-blur-md ${
        inWatchlist 
